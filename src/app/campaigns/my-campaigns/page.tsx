...
const ChainFundMe = () => {
  ...
  const categories = ["Crises Relief", "Academics", "Travel", "Health", "Etc"];
  ...
  return (
    <div className="relative  text-white overflow-hidden w-full">
      ...
      <p className="text-xl text-gray-300 mb-5 max-w-2xl mx-auto">
        Create and manage funding campaigns onchain without limits, restrictions
        and setbacks - bringing hope onchain.
      </p>
            ...
            {faqs.map((faq, index) => (
              <div key={index} className=" rounded-xl">
                <button
                  ...
                  className="w-full flex items-center justify-between p-6 text-left hover:bg-blue-900/10 transition-colors rounded-xl"
                >
