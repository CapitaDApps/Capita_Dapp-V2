...
//   // react-hook-form + zod for date validation
//   const methods = useForm<z.infer<typeof DateOnlySchema>>({
//     resolver: zodResolver(DateOnlySchema),
...
//     console.log("Validated date range:", data);
//     handleSubmitClick();
//   });
...
//         <div>
//           <DateForm control={control} startDate={startDateObj} />
//         </div>
...
//                 <div
//                   aria-hidden
//                   className="hidden lg:block w-px bg-[#666666]"
//                 />
//                 <div
//                   aria-hidden
